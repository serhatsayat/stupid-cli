...
- [ ] **S01: Auth storage and onboarding wizard** `risk:medium` `depends:[]`
...
- [ ] **S02: Interactive TUI mode** `risk:high` `depends:[S01]`
...
- [ ] **S03: Auth integration tests and e2e gate fix** `risk:low` `depends:[S01]`
